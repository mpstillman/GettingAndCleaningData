...
The script located in the GettingAndCleaningData Repo contains the required R code that will export to Tidy Data Set from the Activity Recognition experiments completed by SmartLab.
This script is required to complete the "Getting And Cleaning Data" course project for the Coursera Data Science program.
...
Original information from the Activity Recognition experiments
==================================================================
